...
contract DutchClipperTest is DSTest {
    ...
    function test_Hole_hole() public {
        ...
        (, uint256 tab2, uint256 lot2,,,) = clip2.sales(1);
    ...
    function test_partial_liquidation_Hole_limit() public {
        ...
        assertEq(ink(ilk, me), 40 ether);
        assertEq(art(ilk, me), 100 ether);
        ...
        assertEq(ink(ilk, me), 40 ether - lot);
        assertEq(art(ilk, me), 100 ether - tab * WAD / rate / chop);
